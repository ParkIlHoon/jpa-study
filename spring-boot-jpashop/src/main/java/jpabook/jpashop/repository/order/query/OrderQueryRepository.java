...
public class OrderQueryRepository
{
    ...
    public List<OrderQueryDto> findAllByDto_optimization()
    {
        ...
        Map<Long, List<OrderItemQueryDto>> orderItemMap = findOrderItemMap(orders);
    ...
    private Map<Long, List<OrderItemQueryDto>> findOrderItemMap(List<OrderQueryDto> orders)
    {
        List<Long> collect = orders.stream().map(o -> o.getOrderId()).collect(Collectors.toList());
